...
function loadModel($name)
{
    ...
    if (file_exists(ROOT . 'models' . DS . strtolower($trans_name) . '.php')) {
        require ROOT . 'models' . DS . strtolower($trans_name) . '.php';
        return;
    }
...
{
    $class_name = getModelName($name);
    if (!class_exists($class_name)) {
        loadModel($name);
    }
    $o = classRegistry:: getObject($class_name);
    return $o;
}
