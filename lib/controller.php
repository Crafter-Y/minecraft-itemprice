...
abstract class Controller
{
    ...
    function __construct()
    {
        ...
        if (false !== $parent_name) {
            do {
                $appVars = get_class_vars($parent_name);
                ...
                $parent_name = get_parent_class($parent_name);
            } while ('AppController' !== $parent_name && false !== $parent_name);
        }
    }
     ...
     * @param Exception $exception previously occured exception
     * @throws Exception
     */
